<template>
	<view class="notify">
		<view class="promotion-center">
			<!-- 日常管理 -->
			<list-cell icon="iconyingyong" :iconColor="themeColor.color" navigateType=""  title="功能管理" ></list-cell>
			<view class="category-list">
				<view class="category" v-for="(item, index) in manageSectionList" :key="index" @tap="navTo(item)">
					<view >
						<view class="img">
